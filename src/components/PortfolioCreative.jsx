...
const Portfolio = () => {
  ...
  //   setIsOpen4(!isOpen4);
  // }
  const toAppOverload = (e) =>{
    e.preventDefault()
   
    window.open('https://app-overload.herokuapp.com/',"_blank").focus()
  }
  const toInstasplash = (e) =>{
    e.preventDefault()
   
    window.open('https://instasplash-live.herokuapp.com/login',"_blank").focus()
  }

  const toPetfriendly = (e) =>{
    e.preventDefault()
   
    window.open('https://petfriendlyy.herokuapp.com',"_blank").focus()
  }
  return (
    <>
      <SimpleReactLightbox>
                  ...
                  <ul className="portfolio_list">
                    <li data-aos="fade-right" data-aos-duration="1200">
                      <div className="inner">
                        <div className="entry tokyo_tm_portfolio_animation_wrap">
                          <img
                            src="assets/img/portfolio/appoverload.png"
                            alt="Vimeo"
                            data-tip
                            data-for="vimeo"
                            onClick={toAppOverload}
                          />
                          <ReactTooltip
                            id="vimeo"
                            place="bottom"
                    ...
                    >
                      <div className="inner">
                        <div className="entry tokyo_tm_portfolio_animation_wrap">
                          <img
                            src="assets/img/portfolio/instasplash.png"
                            alt="Youtube"
                            data-tip
                            data-for="youtube"
                            onClick={toInstasplash}
                          />
                          <ReactTooltip
                            id="youtube"
                            place="bottom"
                        ...
                        <div className="inner">
                          <div className="entry tokyo_tm_portfolio_animation_wrap">
                            {/* <a href="assets/img/portfolio/4.jpg"> */}
                              <img
                                src="assets/img/portfolio/petFriendly.png"
                                alt="Childhood"
                                data-tip
                                data-for="shot"
                                onClick={toPetfriendly}
                              />
                              <ReactTooltip
                                id="shot"
                                place="bottom"
